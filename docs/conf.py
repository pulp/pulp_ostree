# -*- coding: utf-8 -*-
#
# Pulp OSTree documentation build configuration file, created by
...
htmlhelp_basename = 'PulpOSTreedoc'
...
latex_documents = [
  ('index', 'PulpOSTree.tex', u'Pulp OSTree Documentation',
   u'Pulp Team', 'manual'),
]
...
man_pages = [
    ('index', 'pulpostree', u'Pulp OSTree Documentation',
     [u'Pulp Team'], 1)
]
...
texinfo_documents = [
  ('index', 'PulpOSTree', u'Pulp OSTree Documentation',
   u'Pulp Team', 'PulpOSTree', 'One line description of project.',
   'Miscellaneous'),
]
...
# this needs a "fixedbugs" after the first pulp_ostree release
