...
response = session.get("https://api.github.com/repos/pulp/pulp_ostree/labels", headers=headers)
...
for label in old_labels.difference(new_labels):
    response = session.delete(
        f"https://api.github.com/repos/pulp/pulp_ostree/labels/{label}", headers=headers
    )
...
for label in new_labels.difference(old_labels):
    ...
    response = session.post(
        "https://api.github.com/repos/pulp/pulp_ostree/labels",
        headers=headers,
