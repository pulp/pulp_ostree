...
# Check out the pulp-cli-ostree branch matching the installed version.
PULP_CLI_VERSION="$(uv pip freeze | sed -n -e 's/pulp-cli-ostree==//p')"
...
cp ~/.config/pulp/cli.toml "../pulp-cli-ostree/tests/cli.toml"
