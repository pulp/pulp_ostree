...
COMPONENT_SOURCE="./pulp_ostree/dist/pulp_ostree-${COMPONENT_VERSION}-py3-none-any.whl"
if [ "$TEST" = "s3" ]; then
...
legacy_component_name: "pulp_ostree"
component_name: "ostree"
...
image:
  ...
  webserver_snippet: $(test -f pulp_ostree/app/webserver_snippets/nginx.conf && echo -n true || echo -n false )
extra_files:
  - origin: "pulp_ostree"
    destination: "pulp_ostree"
services:
  - name: "pulp"
    image: "pulp:ci_build"
    volumes:
