...
# steps
WEB_SYNC_MAIN_STEP = 'web_sync_main_step'
WEB_SYNC_CREATE_STEP = 'web_sync_create_step'
WEB_SYNC_PULL_STEP = 'web_sync_pull_step'
WEB_SYNC_ADD_STEP = 'web_sync_add_step'
