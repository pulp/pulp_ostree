...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='OstreeRefsHead',
            fields=[
                ('content_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='ostree_ostreerefshead', serialize=False, to='core.content')),
                ('name', models.CharField(db_index=True, max_length=255)),
                ('commit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='refshead_commit', to='ostree.ostreecommit')),
            ],
            options={
                'default_related_name': '%(app_label)s_%(model_name)s',
