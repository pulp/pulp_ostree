"""Tests that CRUD ostree remotes."""
...
from pulp_ostree.tests.functional.constants import DOWNLOAD_POLICIES
...
from pulpcore.client.pulp_ostree import RemotesOstreeApi
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.remote_api = RemotesOstreeApi(gen_ostree_client())
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/pulp/pulp-smash/issues/984>`_
        ...
        del body["url"]
        with self.assertRaises(ApiException):
            RemotesOstreeApi(gen_ostree_client()).create(body)
