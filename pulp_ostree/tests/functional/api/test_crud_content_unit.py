...
class ContentUnitTestCase(unittest.TestCase):
    ...
    * `Pulp Smash #870 <https://github.com/pulp/pulp-smash/issues/870>`_
    ...
    def test_01_create_content_unit(self):
        """Create content unit."""
        attrs = gen_ostree_content_attrs(self.artifact)
        response = self.ostree_content_api.create(**attrs)
        created_resources = monitor_task(response.task).created_resources
        content_unit = self.ostree_content_api.read(created_resources[0])
    ...
    def test_02_read_content_unit(self):
        ...
        content_unit = self.ostree_content_api.read(self.content_unit["pulp_href"]).to_dict()
    ...
    def test_02_read_content_units(self):
        ...
        page = self.ostree_content_api.list(relative_path=self.content_unit["relative_path"])
    ...
    def test_03_partially_update(self):
        ...
        with self.assertRaises(AttributeError) as exc:
            self.ostree_content_api.partial_update(self.content_unit["pulp_href"], attrs)
    ...
    def test_03_fully_update(self):
        ...
        attrs = gen_ostree_content_attrs(self.artifact)
        with self.assertRaises(AttributeError) as exc:
            self.ostree_content_api.update(self.content_unit["pulp_href"], attrs)
    ...
    def test_04_delete(self):
        ...
        """
        with self.assertRaises(AttributeError) as exc:
            self.ostree_content_api.delete(self.content_unit["pulp_href"])
